...
<html lang="hr">
    <head>
        ...
        <meta name="tittle" content="Upravljanje korisnicima">
        <meta name="description" content="Administrator upravlja korisnicima (otključavanje i blokiranje)">
        <meta name="keywords" content="Prijava; Vlakovi; HŽ">
        ...
        <script src="javascript/upravljanjeKorisnicima.js"></script> 
    ...
    <header class="header">
        <div class="header__inner">
            ...
            <h1 class="header__title">Pregled korisnika</h1>
        </div>
    </header>
        <section id="section-hero" class="section-hero">
             <table id="korisnici" class="tablica" style="text-align: left">
                <tr>
                    <th>Korisnično ime</th><th>Ime</th><th>Prezime</th><th>Email</th><th>Neuspješne prijave</th><th>Status</th><th></th>
                </tr><tr>
